...
/// <summary>
/// Closed-loop channel implementation for NV40/3CLE devices.
/// </summary>
public sealed class NV403CLEChannel : NVFamilyChannel
{
    /// <summary>
    /// Initializes a new NV403CLE channel and closed-loop capabilities.
    /// </summary>
    /// <param name="id">Channel identifier.</param>
    /// <param name="writeCallback">Channel write callback.</param>
    public NV403CLEChannel(int id, PsjLib.Base.ChannelWriteCallback writeCallback)
